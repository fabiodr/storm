"""
STORM Wiki pipeline with a focus on software and systems architecture research.
...
def main(args):
    ...
    research_module = SoftwareArchitectureResearchModule(article_gen_lm=article_gen_lm, retrieve_top_k=engine_args.retrieve_top_k, max_thread_num=engine_args.max_thread_num)
...
if __name__ == '__main__':
    ...
    # global arguments
    parser.add_argument('--output-dir', type=str, default='./results/software_architecture',
